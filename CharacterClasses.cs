...
namespace Character
{
    public class CharacterClassList
    {
        ...
        // private List<string> CharacterClasses = new List<string>(){"Bard", "Barbarian", "Cleric", "Fighter", "Monk", "Paladin", "Ranger", "Rogue"};
        private List<string> CharacterClasses = new List<string>(){"Rogue"};
